 ...
 */
final class Version20250305102828 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE infos (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, user_rank VARCHAR(255) NOT NULL, victoire VARCHAR(255) NOT NULL, defaite VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_EECA826DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
